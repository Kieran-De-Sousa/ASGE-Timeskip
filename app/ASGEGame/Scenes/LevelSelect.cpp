...
bool SceneLevelSelect::init()
{
  ...
  Level1.setFont(*game_font).setString("PLAY .").setPosition({ 360, 600 }).setScale(0.5);
  Level1.setFont(*game_font).setString("LEVEL SELECT").setPosition({ 360, 700 }).setScale(0.5);
